...
NDEVICES_PER_NODE=8
PROJECT_NAME=rl
EXPERIMENT_NAME=grpo-all-43k-qwen3-8b-w-sft
...
# fill in the SFT checkpoint produced by run_sft.sh
export MODEL_PATH=$SPECTUNE_ROOT/outputs/checkpoints/spectune/sft-all-rollout-qwen3-8b/global_step_216/huggingface
