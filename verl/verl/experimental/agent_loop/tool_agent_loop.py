...
class ToolAgentLoop(AgentLoopBase):
    ...
    async def _handle_generating_state(
        ...
        if os.getenv("VERL_DEBUG"):
            ...
            print(f"\n[DEBUG] === policy generation (assistant turn {agent_data.assistant_turns}) ===")
            print(f"[DEBUG] response_text = {_response_text!r}")
            print(f"[DEBUG] tool_calls parsed = {agent_data.tool_calls}")
            breakpoint()
    ...
    async def _call_tool(
        ...
        try:
            ...
            if os.getenv("VERL_DEBUG"):
                print(f"\n[DEBUG] === tool execution: {tool_name} ===")
                print(f"[DEBUG] tool_args = {tool_args}")
                print(f"[DEBUG] tool_execution_response.text = {tool_execution_response.text!r}")
